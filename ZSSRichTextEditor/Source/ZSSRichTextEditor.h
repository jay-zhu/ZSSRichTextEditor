...
static NSString * const ZSSRichTextEditorToolbarSmallFontSize = @"com.zedsaid.toolbaritem.smallFontSize";
static NSString * const ZSSRichTextEditorToolbarMediumFontSize = @"com.zedsaid.toolbaritem.mediumFontSize";
static NSString * const ZSSRichTextEditorToolbarLargeFontSize = @"com.zedsaid.toolbaritem.largeFontSize";
